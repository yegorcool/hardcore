        ...
        <div class="w-full">
            <div class="p-4">
                ...
                <div class="border-b py-1 mb-2">
                    ...
                    <span class="text-gray-900 text-xl ">{{ $video->videoRecipient->name }}</span>
                </div>
                <!-- Дата платежа -->
                <div class="border-b  py-1 mb-2">
                    <x-input-label class="w-1/5 inline-block" :value="__('Дата загрузки: ')"/>
                    <span class="text-gray-900 text-xl ">{{$video->created_at->format('d.m.Y H:i')}}</span>
                </div>

                <div class="border-b  py-1 lg:flex mb-2">
                    <!-- topic -->
                    <div class="  w-full lg:w-1/2 mr-10">
                        <x-input-label class="w-2/5 inline-block" :value="__('Название: ')"/>
                        <span class="text-gray-900 text-xl ">{{ $video->title }}</span>
                    </div>
                ...
                <div class="border-b  py-1 mb-4">
                    ...
                    <p class="block mt-1 w-full text-gray-900 text-xl ">{{$video->comment}}</p>
                </div>
                <div class="border-b lg:flex  py-1 mb-2">
                    <!-- status -->
                    <div class=" w-full lg:w-1/2">
                        <x-input-label class="w-2/5 inline-block" for="role" :value="__('Статус: ')"/>
                        <span class="text-gray-900 text-xl ">{{$video->status}}</span>
                    </div>
                </div>
            </div>
        </div>
