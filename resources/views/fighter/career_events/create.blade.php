...
@section('titlebutton')
    <div class="theme-btn  ">
        <a class="text-white hover:text-gray-100"
           href="{{ route('fighter.profile', $fighter->id )  }}"
           class=""><i
    ...
    <section class="container-fluid bg-black shadow-xl shadow-white/30 text-gray-400 px-lg-5 mx-auto sm:px-6 lg:px-8">
        <div class="w-full lg:w-2/3  ">
            ...
            <div class="my-4 lg:col-8">
                <form method="POST" action="{{ route('fighter.career_events.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Name -->
                    ...
                    <div class="pb-2">
                        ...
                        <x-text-input id="date_start" class="block mt-1 w-full" type="datetime-local" name="date_start" :value="old('date_start')" required/>
                    ...
                    <div class="pb-2">
                        ...
                        <x-text-input id="date_end" class="block mt-1 w-full" type="datetime-local" name="date_end" :value="old('date_end')"/>
