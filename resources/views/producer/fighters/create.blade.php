...
{{--                    File Upload--}}
                    ...
                    <div>
                        <x-input-label for="gallery_images" :value="__('Галерея')"/>
                        <x-text-input id="gallery_images" class="block mt-1 w-full" type="file" multiple name="gallery_images[]" :value="old('gallery_images')"/>
