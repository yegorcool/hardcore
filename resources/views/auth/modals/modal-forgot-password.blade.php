...
<div class="modal fade bg-black/80" id="forgotPasswordModal" tabindex="-1" aria-labelledby="forgotPasswordLabel"
     aria-hidden="true">
        ...
        <div class="modal-body modal-content bg-transparent border-none">
            <x-auth.card>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <x-theme-button class="bg-themeRed" data-dismiss="modal">
